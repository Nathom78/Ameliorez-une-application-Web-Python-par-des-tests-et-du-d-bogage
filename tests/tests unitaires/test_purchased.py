...
class TestPurchase:
    ...
    def test_book_more_12_places_should_return_error_message(self, client, clubs_fixture, competitions_fixture, mocker):
        ...
        assert b"Sorry, you cannot book more than 12 places." in response.data
        assert response.status_code == 200

    def test_book_12_places_should_return_no_error_message(self, client, clubs_fixture, competitions_fixture, mocker):
        """
